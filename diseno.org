...
Cada enemigo da monedas de $random([rglobal, rlocal + rglobal])$. Tienen un 85% de dejar moneda.
...
y =roll= puede ser cara o cruz. Salga lo que salga, se aplica un buff. Al aplicar un buff, 
