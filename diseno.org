...
Vampire survivors-like, horde-survival, top-down 2D. se acumulan "monedas", que son buffs temporales hasta que se asientan en el mercader. Dificultad creciente de enemigos para gestionar gráfica de dificultad. La ronda es una acumulación de dificultad/buff que hay que "resetear" en el mercader.
...
- Cara: Dispara un objeto en la dirección en la que se mueve cada 2.5 segundos. El objeto viaja 2 veces la velocidad de la pantalla, y va a $4\times$ de la velocidad del jugador.
- Cruz: Te quedas parado durante 1 segundo, cada 10 segundos.
...
- Durante 10 segundos eres invulnerable
- Durante 10 segundos recibes el doble de daño
...
Las progresiones son cíclicas, basadas en rondas. En general, la función es: $movimiento = 1 + 0.008 \times rlocal^2 + 0.0008 \times rglobal^2$.
...
#+plot: file:"./crecimiento.svg" deps:(2 3)
...
| # |           17 |           5 |       1.33 | 1.43 |             450 |
| # |           18 |           6 |       1.43 | 1.55 |             540 |
#+TBLFM: $4='(format "%.2f" (+ 1 (* 0.0008 (expt (- $ronda_global 1) 2)) (* 0.008 (expt  (- $ronda_local 1) 2))));N::$5='(format "%.2f" (+ 1 (* 0.0008 (expt $ronda_global 2)) (* 0.008 (expt  $ronda_local 2))));N::$6='(* $ronda_local remote(constantes, @1$2));N
